...
def main():
    ...
    Order_date = st.text_input("10.Order date ","1/17/2018 12:06")
    OrderCity = st.selectbox("11.OrderCity",("Bekasi","Bikaner","Santo Domingo","New York City","Los Angeles","Tegucigalpa","Managua""Aix-les-Bains","patinga","Iringa","Midyat","Yanji"))
    Order_Country = st.selectbox("12.Order Country",("India","China","Estados Unidos","México","Francia","Alemania","Australia","Eritrea","Sáhara Occidental","Burundi","Serbia"))
    # Order_day = st.text_input("13.order day","Type Here")
